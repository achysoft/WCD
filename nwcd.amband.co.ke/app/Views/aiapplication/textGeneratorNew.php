            ...
            <div class="card h-full p-0">
                <div class="card-body p-0">
                    ...
                    <ul class="ai-chat-list scroll-sm pe-6 ps-1.5 pb-6">
                        ...
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="text-line-1 text-secondary-light text-hover-primary-600">UI/UX Design Roadmap write me the roadmap right now </a>
                        </li>
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        ...
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="text-line-1 text-secondary-light text-hover-primary-600">Online School Education Learning</a>
                        </li>
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
