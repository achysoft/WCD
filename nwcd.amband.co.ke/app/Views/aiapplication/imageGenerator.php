                                        ...
                                        <div class="grid sm:grid-cols-12 gap-6">
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="<?= base_url('assets/images/chatgpt/image-generator1.png') ?>" alt="" class="w-full h-full object-fit-cover">
                                            ...
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="<?= base_url('assets/images/chatgpt/image-generator2.png') ?>" alt="" class="w-full h-full object-fit-cover">
                                                    <div class="form-check style-check flex items-center absolute top-0 start-0 ms-8 mt-2">
                                            ...
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="<?= base_url('assets/images/chatgpt/image-generator3.png') ?>" alt="" class="w-full h-full object-fit-cover">
                                                    <div class="form-check style-check flex items-center absolute top-0 start-0 ms-8 mt-2">
                                            ...
                                            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                                                <div class="generated-image-item rounded-lg overflow-hidden relative">
                                                    <img src="<?= base_url('assets/images/chatgpt/image-generator4.png') ?>" alt="" class="w-full h-full object-fit-cover">
                                                    <div class="form-check style-check flex items-center absolute top-0 start-0 ms-8 mt-2">
