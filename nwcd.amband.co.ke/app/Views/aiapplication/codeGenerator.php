                ...
                <div class="card p-0 border-0">
                    <div class="card-body p-0">
                        ...
                        <ul class="ai-chat-list scroll-sm px-6 pb-6 max-h-[644px] overflow-y-auto">
                            ...
                            <li class="mb-4">
                                <a href="<?= route_to('textGenerator') ?>" class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Please create a 5 Column table with HTM</a>
                            </li>
                            <li class="mb-4">
                                <a href="<?= route_to('textGenerator') ?>" class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                            </li>
                            <li class="mb-4">
                                <a href="<?= route_to('textGenerator') ?>" class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                            </li>
                            ...
                            <li class="mb-4">
                                <a href="<?= route_to('textGenerator') ?>" class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Online School Education Learning</a>
                            </li>
                            <li class="mb-4">
                                <a href="<?= route_to('textGenerator') ?>" class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                            </li>
                            ...
                            <div class="card-body p-0 max-h-[612px] min-h-[612px] overflow-y-auto">
                                ...
                                <div class="py-4 px-6 border-b border-neutral-200 dark:border-neutral-600">
                                    <div class="flex items-start gap-3">
                                        <img src="<?= base_url('assets/images/wow-dash-favicon.png') ?>" alt="" class="w-10 h-10 rounded-full">
                                        <div class="">
