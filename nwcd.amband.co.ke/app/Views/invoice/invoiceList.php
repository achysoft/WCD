            ...
            <div class="card border-0">
                <div class="card-header flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="<?= route_to('invoiceAdd') ?>" class="btn btn-sm text-white bg-primary-600 hover:bg-primary-700 flex items-center gap-2"><i class="ri-add-line"></i> Create Invoice</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table bordered-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list1.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list2.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list3.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list4.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list5.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list6.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list7.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list8.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list9.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-list/user-list10.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
