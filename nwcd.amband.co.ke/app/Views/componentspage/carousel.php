            ...
            <div class="card p-0 overflow-hidden relative rounded-xl border-0">
                ...
                <div class="card-body p-0 default-carousel">
                    <div class="before:absolute before:w-full before:h-full before:bg-gradient-to-t from-neutral-900/75 before:z-[1] z-1 relative bottom-0 start-0 h-full">
                        <img src="<?= base_url('assets/images/carousel/carousel-img1.png') ?>" alt="" class="w-full h-full object-fit-cover">
                    ...
                    <div class="before:absolute before:w-full before:h-full before:bg-gradient-to-t from-neutral-900/75 before:z-[1] z-1 relative bottom-0 start-0 h-full">
                        <img src="<?= base_url('assets/images/carousel/carousel-img2.png') ?>" alt="" class="w-full h-full object-fit-cover">
                        <div class="absolute start-1/2 -translate-x-1/2 bottom-0 pb-6 z-[2] text-center w-full max-w-[440px]">
                    ...
                    <div class="before:absolute before:w-full before:h-full before:bg-gradient-to-t from-neutral-900/75 before:z-[1] z-1 relative bottom-0 start-0 h-full">
                        <img src="<?= base_url('assets/images/carousel/carousel-img3.png') ?>" alt="" class="w-full h-full object-fit-cover">
                        <div class="absolute start-1/2 -translate-x-1/2 bottom-0 pb-6 z-[2] text-center w-full max-w-[440px]">
        ...
        <div class="col-span-12 sm:col-span-6">
            <div class="card p-0 overflow-hidden relative rounded-xl border-0">
                ...
                <div class="card-body p-0 arrow-carousel">
                    ...
                    <div class="before:absolute before:w-full before:h-full before:bg-gradient-to-t from-neutral-900/75 before:z-[1] z-1 relative bottom-0 start-0 h-full">
                        <img src="<?= base_url('assets/images/carousel/carousel-img4.png') ?>" alt="" class="w-full h-full object-fit-cover">
                        <div class="absolute start-1/2 -translate-x-1/2 bottom-0 pb-6 z-[2] text-center w-full max-w-[440px]">
                            <h5 class="card-title text-white text-lg mb-1.5">Carousel Slide Two</h5>
                            <p class="card-text text-white mx-auto text-sm">User Interface (UI) and User Experience (UX) Design play key roles in the experience users have when </p>
                        </div>
        ...
        <div class="col-span-12">
            <div class="card p-0 overflow-hidden relative rounded-xl border-0">
                ...
                <div class="card-body py-6 px-4 multiple-carousel slick-dots-style-two">
                    <div class="mx-2 mb-6">
                        <img src="<?= base_url('assets/images/carousel/mutiple-carousel-img1.png') ?>" class="w-full h-full object-fit-cover" alt="">
                    </div>
                    <div class="mx-2 mb-6">
                        <img src="<?= base_url('assets/images/carousel/mutiple-carousel-img2.png') ?>" class="w-full h-full object-fit-cover" alt="">
                    </div>
                    <div class="mx-2 mb-6">
                        <img src="<?= base_url('assets/images/carousel/mutiple-carousel-img3.png') ?>" class="w-full h-full object-fit-cover" alt="">
                    </div>
                    <div class="mx-2 mb-6">
                        <img src="<?= base_url('assets/images/carousel/mutiple-carousel-img4.png') ?>" class="w-full h-full object-fit-cover" alt="">
                    </div>
                    <div class="mx-2 mb-6">
                        <img src="<?= base_url('assets/images/carousel/mutiple-carousel-img2.png') ?>" class="w-full h-full object-fit-cover" alt="">
                    </div>
