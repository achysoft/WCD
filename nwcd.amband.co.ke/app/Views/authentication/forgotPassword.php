            ...
            <div class="lg:max-w-[464px] mx-auto w-full">
                ...
                <form action="#">
                    ...
                    <div class="text-center">
                        <a href="<?= route_to('signin') ?>" class="text-primary-600 font-bold mt-6 hover:underline">Back to Sign In</a>
                    </div>

                    <div class="mt-10 md:mt-[60px] lg:mt-[100px] xl:mt-[120px] text-center text-sm">
                        <p class="mb-0">Already have an account?  <a href="<?= route_to('signin') ?>" class="text-primary-600 font-semibold hover:underline">Sign In</a></p>
                    </div>
