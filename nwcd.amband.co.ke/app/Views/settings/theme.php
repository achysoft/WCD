                    ...
                    <div class="mb-5">
                        ...
                        <div class="avatar-upload mt-4">
                            <div class="avatar-preview">
                                <div id="previewImage1" class=" w-[120px] h-[120px] rounded-lg border border-neutral-300 bg-center bg-no-repeat bg-cover" style="background-image: url('<?= base_url("assets/images/payment/upload-image.png") ?>');"></div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-5">
                        ...
                        <div class="avatar-upload mt-4">
                            <div class="avatar-preview">
                                <div id="previewImage2" class=" w-[120px] h-[120px] rounded-lg border border-neutral-300 bg-center bg-no-repeat bg-cover" style="background-image: url('<?= base_url("assets/images/payment/upload-image.png") ?>');"></div>
                            </div>
                        </div>
                    </div>
                </div>
