                ...
                <div class="card-body">
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/users/user1.png') ?>" alt="" class="w-10 h-10 rounded-full
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/users/user2.png') ?>" alt="" class="w-10 h-10 rounded-full
                            flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/users/user3.png') ?>" alt="" class="w-10 h-10 rounded-full
                            flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/users/user4.png') ?>" alt="" class="w-10 h-10 rounded-full
                            flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/users/user5.png') ?>" alt="" class="w-10 h-10 rounded-full
                            flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
        ...
        <div class="col-span-12 md:col-span-6 2xl:col-span-4">
            <div class="card border-0 h-full">
                ...
                <div class="card-body">
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/home-six/student-img1.png') ?>" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/home-six/student-img2.png') ?>" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/home-six/student-img3.png') ?>" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/home-six/student-img4.png') ?>" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-6">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/home-six/student-img5.png') ?>" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-0">
                        <div class="flex items-center">
                            <img src="<?= base_url('assets/images/home-six/student-img6.png') ?>" alt="" class="w-10 h-10 rounded-lg flex-shrink-0 me-3 overflow-hidden">
                            <div class="flex-grow-1">
