                                ...
                                <div class="flex flex-col gap-6">
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/home-eight/doctor-img1.png') ?>" alt="" class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/home-eight/doctor-img2.png') ?>" alt="" class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/home-eight/doctor-img3.png') ?>" alt="" class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/home-eight/doctor-img4.png') ?>" alt="" class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/home-eight/doctor-img6.png') ?>" alt="" class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/home-eight/doctor-img5.png') ?>" alt="" class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
