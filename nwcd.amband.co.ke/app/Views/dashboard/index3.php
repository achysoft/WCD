...
<?= $this->section('script'); ?>
    <script src="<?= base_url('assets/js/homeChart/homethreeChart.js') ?>"></script>
<?= $this->endSection(); ?>
                        ...
                        <table class="table bordered-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/users/user1.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/users/user2.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/users/user3.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/users/user4.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/users/user5.png') ?>" alt="" class="shrink-0 me-3 rounded-lg">
                    ...
                    <div class="mt-8">
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/payment/payment1.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/payment/payment2.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/payment/payment3.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-5">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/payment/payment4.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                    ...
                    <div class="">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                            <div class="flex items-center w-full">
                                <img src="<?= base_url('assets/images/flags/flag1.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                            <div class="flex items-center w-full">
                                <img src="<?= base_url('assets/images/flags/flag2.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-3 pb-2">
                            <div class="flex items-center w-full">
                                <img src="<?= base_url('assets/images/flags/flag3.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <div class="flex items-center w-full">
                                <img src="<?= base_url('assets/images/flags/flag4.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0 me-4">
                                <div class="grow">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/users/user6.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/users/user1.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/users/user2.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/users/user3.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <div class="flex items-center justify-between gap-3 mb-8">
                            <div class="flex items-center gap-2">
                                <img src="<?= base_url('assets/images/users/user4.png') ?>" alt="" class="w-10 h-10 rounded-lg shrink-0">
                                <div class="grow">
                        ...
                        <table class="table bordered-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/product/product-img1.png') ?>" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                            <div class="grow">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/product/product-img2.png') ?>" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                            <div class="grow">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/product/product-img3.png') ?>" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                            <div class="grow">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/product/product-img4.png') ?>" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                            <div class="grow">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/product/product-img5.png') ?>" alt="" class="shrink-0 me-3 rounded-lg me-3">
                                            <div class="grow">
