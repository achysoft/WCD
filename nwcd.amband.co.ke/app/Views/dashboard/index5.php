...
<?= $this->section('script'); ?>
    <script src="<?= base_url('assets/js/homeChart/homeFiveChart.js') ?>"></script>
<?= $this->endSection(); ?>
                            ...
                            <table class="table bordered-table sm-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flex items-center">
                                                <img src="<?= base_url('assets/images/asset/asset-img1.png') ?>" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                                <div class="grow">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flex items-center">
                                                <img src="<?= base_url('assets/images/asset/asset-img2.png') ?>" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                                <div class="grow">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flex items-center">
                                                <img src="<?= base_url('assets/images/asset/asset-img3.png') ?>" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                                <div class="grow">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flex items-center">
                                                <img src="<?= base_url('assets/images/asset/asset-img4.png') ?>" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                                <div class="grow">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flex items-center">
                                                <img src="<?= base_url('assets/images/asset/asset-img5.png') ?>" alt="" class="shrink-0 w-10 h-10 rounded-lg me-3">
                                                <div class="grow">
                ...
                <div class="card h-full border-0">
                    <div class="card-body p-6">
                        ...
                        <div class="flex items-start gap-2 mb-5">
                            <img src="<?= base_url('assets/images/notice/board-img1.png') ?>" alt="" class="shrink-0 w-10 h-10 me-3 rounded-lg">
                            <div class="grow">
                        ...
                        <div class="flex items-start gap-2 mb-5">
                            <img src="<?= base_url('assets/images/notice/board-img2.png') ?>" alt="" class="shrink-0 w-10 h-10 me-3 rounded-lg">
                            <div class="grow">
                        ...
                        <div class="flex items-start gap-2">
                            <img src="<?= base_url('assets/images/notice/board-img3.png') ?>" alt="" class="shrink-0 w-10 h-10 me-3 rounded-lg">
                            <div class="grow">
