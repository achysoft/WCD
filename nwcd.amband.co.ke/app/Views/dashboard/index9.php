                ...
                <div class="card-body p-5">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div class="col-span-12 md:col-span-4">
                            <div class="trail-bg h-full text-center flex flex-col justify-between items-center p-4 rounded-lg bg-cover bg-no-repeat bg-center" style="background-image: url('<?= base_url("assets/images/home-nine/trail-bg.png") ?>');">
                                ...
                                <div class="max-h-[266px] overflow-y-auto scroll-sm pe-1">
                                    <div class="flex items-center justify-between gap-4 mb-2 pb-2">
                                        <div class="flex items-center w-full">
                                            <img src="<?= base_url('assets/images/flags/flag1.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-4 mb-2 pb-2">
                                        <div class="flex items-center w-full">
                                            <img src="<?= base_url('assets/images/flags/flag2.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-4 mb-2 pb-2">
                                        <div class="flex items-center w-full">
                                            <img src="<?= base_url('assets/images/flags/flag3.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-4 mb-2 pb-2">
                                        <div class="flex items-center w-full">
                                            <img src="<?= base_url('assets/images/flags/flag4.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center justify-between gap-4 mb-2 pb-2">
                                        <div class="flex items-center w-full">
                                            <img src="<?= base_url('assets/images/flags/flag5.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3">
                                            <div class="flex-grow-1">
                        ...
                        <table class="table bordered-table mb-0 rounded-0 border-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-grid/user-grid-img1.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-grid/user-grid-img2.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-grid/user-grid-img3.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-grid/user-grid-img4.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                            <img src="<?= base_url('assets/images/user-grid/user-grid-img5.png') ?>" alt="" class="w-[40px] h-[40px] rounded-[50%] shrink-0 me-3 overflow-hidden">
                                            <div class="flex-grow-1">
