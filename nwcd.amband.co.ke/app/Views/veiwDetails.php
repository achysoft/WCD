                        ...
                        <div class="card-body p-0">
                            <div class="py-4 px-6 border-b border-neutral-200 dark:border-neutral-600">
                                <div class="flex items-start gap-3">
                                    <img src="<?= base_url('assets/images/user-list/user-list1.png') ?>" alt="" class="w-10 h-10 rounded-full">
                                    <div class="">
                            ...
                            <div class="py-4 px-6 border-b border-neutral-200 dark:border-neutral-600">
                                <div class="flex items-start gap-3">
                                    <img src="<?= base_url('assets/images/user-list/user-list2.png') ?>" alt="" class="w-10 h-10 rounded-full">
                                    <div class="">
                                        <div class="flex items-center flex-wrap gap-2">
