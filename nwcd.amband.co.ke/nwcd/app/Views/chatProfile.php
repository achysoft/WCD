...
<?= $this->section('content'); ?>
    ...
    <div class="chat-wrapper">
        <div class="chat-sidebar profile-setting card">
            <div class="text-end">
                <a href="<?= route_to('chatMessage') ?>"><iconify-icon icon="akar-icons:cross"></iconify-icon></a>
            </div>
            <div class="chat-600-profile">
                <div class="img">
                    <img src="<?= base_url('assets/images/chat/chat-600.png') ?>" alt="image">
                </div>
        ...
        <div class="chat-600 card">
            ...
            <div class="chat-message-list">
                <div class="chat-single-message left">
                    <img src="<?= base_url('assets/images/chat/11.png') ?>" alt="image" class="avatar-lg object-fit-cover rounded-full">
