            ...
            <div class="card h-full p-0">
                <div class="card-body p-0">
                    <div class="p-6">
                        ...
                        <a href="<?= route_to('codeGeneratorNew') ?>" class="btn btn-primary text-sm btn-sm px-3 py-3 w-full rounded-lg flex items-center justify-center gap-2">
            ...
            <div class="chat-600 card overflow-hidden">
                <div class="chat-sidebar-single gap-2 justify-between cursor-default flex-nowrap">
                    <div class="flex items-center gap-4">
                        <a href="<?= route_to('codeGeneratorNew') ?>" class="text-neutral-600 dark:text-neutral-200 text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
