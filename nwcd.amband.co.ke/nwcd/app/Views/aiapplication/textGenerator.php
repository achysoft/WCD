        ...
        <div class="col-span-1 lg:col-span-4 2xl:col-span-3">
            <div class="card p-0 border-0">
                <div class="card-body p-0">
                    <div class="p-6">
                        <a href="<?= route_to('textGeneratorNew') ?>" class="btn btn-primary text-sm btn-sm px-3 py-3 w-full rounded-lg flex items-center justify-center gap-2">
                    ...
                    <ul class="ai-chat-list scroll-sm px-6 pb-6 max-h-[644px] overflow-y-auto">
                        ...
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">UI/UX Design Roadmap write me the roadmap right now </a>
                        </li>
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
                        ...
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Online School Education Learning</a>
                        </li>
                        <li class="mb-4">
                            <a <?= route_to('textGenerator') ?> class="line-clamp-1 text-neutral-600 hover:text-primary-600 dark:text-white dark:hover: text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                        </li>
            ...
            <div class="chat-600 card overflow-hidden border-0">
                <div class="chat-sidebar-single gap-2 flex items-center px-6 py-5 justify-between cursor-default flex-nowrap">
                    <div class="flex items-center gap-4">
                        <a href="<?= route_to('textGeneratorNew') ?>" class="text-neutral-600 dark:text-neutral-200 text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
                ...
                <div class="chat-message-list px-6 py-5 max-h-[612px] min-h-[612px] overflow-y-auto">
                    ...
                    <div class="flex items-start justify-between gap-4 border-b border-neutral-200 dark:border-neutral-600 pb-4 mb-4">
                        <div class="flex items-center gap-4">
                            <div class="img overflow-hidden shrink-0">
                                <img src="<?= base_url('assets/images/chat/1.png') ?>" alt="image" class="w-[44px] h-[44px] rounded-full object-fit-cover">
                            </div>
                            <div class="info grow">
                    ...
                    <div class="flex items-start gap-4 border-b border-neutral-200 dark:border-neutral-600 pb-4 mb-4">
                        <div class="img overflow-hidden shrink-0">
                            <img src="<?= base_url('assets/images/wow-dash-favicon.png') ?>" alt="image" class="w-[44px] h-[44px] rounded-full object-fit-cover">
                        </div>
                        <div class="info grow">
