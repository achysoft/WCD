...
<?= $this->section('script'); ?>
    <script src="<?= base_url('assets/js/homeChart/homeFourChart.js') ?>"></script>
<?= $this->endSection(); ?>
...
<?= $this->section('content'); ?> 
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-6">
        <div class="card shadow-none border-gray-200 dark:border-neutral-600 bg-gradient-to-l from-warning-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
                    <img src="<?= base_url('assets/images/currency/crypto-img1.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0">
                    <div class="grow">
        ...
        <div class="card shadow-none border-gray-200 dark:border-neutral-600 bg-gradient-to-l from-blue-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
                    <img src="<?= base_url('assets/images/currency/crypto-img2.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0">
                    <div class="grow">
        ...
        <div class="card shadow-none border-gray-200 dark:border-neutral-600 bg-gradient-to-l from-purple-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
                    <img src="<?= base_url('assets/images/currency/crypto-img3.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0">
                    <div class="grow">
        ...
        <div class="card shadow-none border-gray-200 dark:border-neutral-600 bg-gradient-to-l from-primary-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
                    <img src="<?= base_url('assets/images/currency/crypto-img4.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0">
                    <div class="grow">
        ...
        <div class="card shadow-none border-gray-200 dark:border-neutral-600 bg-gradient-to-l from-warning-600/10 to-bg-white">
            <div class="card-body p-5">
                <div class="flex flex-wrap items-center gap-3">
                    <img src="<?= base_url('assets/images/currency/crypto-img5.png') ?>" alt="" class="w-10 h-10 rounded-full shrink-0">
                    <div class="grow">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="<?= base_url('assets/images/currency/crypto-img1.png') ?>" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="<?= base_url('assets/images/currency/crypto-img2.png') ?>" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="<?= base_url('assets/images/currency/crypto-img3.png') ?>" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="<?= base_url('assets/images/currency/crypto-img4.png') ?>" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 bg-neutral-200 dark:bg-neutral-600 px-2 py-2 rounded mb-4">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <img src="<?= base_url('assets/images/currency/crypto-img5.png') ?>" alt="" class="w-9 h-9 rounded-full shrink-0">
                                    <div class="grow">
                        ...
                        <div>
                            <div class="card-slider">
                                <div class="p-5 h-[240px] rounded-lg overflow-hidden relative z-[1]">
                                    <img src="<?= base_url('assets/images/card/card-bg.png') ?>" alt="" class="absolute start-0 top-0 w-full h-full object-fit-cover -z-[1]">
